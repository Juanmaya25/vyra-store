...
export default function Devoluciones() {
  return (
    <LegalLayout title="Devoluciones y Garantía">
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">3. Cómo solicitar una devolución</h2>
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">4. Reembolsos</h2>
