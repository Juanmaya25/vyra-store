...
export default function Privacidad() {
  return (
    <LegalLayout title="Política de Privacidad">
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">1. Datos que recopilamos</h2>
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">2. Uso de la información</h2>
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">3. Tus derechos</h2>
      <p>Puedes solicitar acceso, corrección o eliminación de tus datos en cualquier momento contactándonos.</p>
      <h2 className="font-display font-bold text-white text-lg pt-4">4. Cookies</h2>
