...
export default function Terminos() {
  return (
    <LegalLayout title="Términos y Condiciones">
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">1. Productos y precios</h2>
      ...
      <h2 className="font-display font-bold text-white text-lg pt-4">2. Pedidos</h2>
